...
func setEnvs() {
	...
	fmt.Println("LOCAL_INPUT:", os.Getenv("LOCAL_INPUT"))
	fmt.Println("LOCAL_OUTPUT:", os.Getenv("LOCAL_OUTPUT"))
	fmt.Println("S3_UPLOAD:", os.Getenv("S3_UPLOAD"))
	fmt.Println("BUCKET_NAME:", os.Getenv("BUCKET_NAME"))
	fmt.Println("OBJECT_KEY:", os.Getenv("OBJECT_KEY"))
}
